...
android {
    namespace = "com.arturotorralbo.aplicacionvideojuegologros"
    compileSdk = 34


    defaultConfig {
        applicationId = "com.arturotorralbo.aplicacionvideojuegologros"
        minSdk = 33
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.test:runner:1.6.0-rc01")
